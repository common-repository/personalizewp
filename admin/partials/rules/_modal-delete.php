...
<dialog id="deleteRuleModal" data-url-action class="dialog">
	<form action="" method="post" accept-charset="UTF-8" class="pwp-form flow">
		<div class="dialog-header">
			<h5 class="dialog-title"><?php esc_html_e( 'Delete rule?', 'personalizewp' ); ?></h5>
		...
		<p><?php esc_html_e( 'Are you sure you want to delete this rule?', 'personalizewp' ); ?></p>
		<div class="actions">
